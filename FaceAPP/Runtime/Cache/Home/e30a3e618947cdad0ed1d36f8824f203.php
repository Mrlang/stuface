...
<body>
	<div id="container">
		...
		<div class="content">
			<!-- 上传按钮 -->
			<img class="rocket" src=".//Public/img/2016.png" alt="">
			<div id="uploading">
				<img class="stone" src=".//Public/img/stone.png" alt="">
			</div>
			<!-- 活动详情 -->
			<div class="activity-detail">
				<img src=".//Public/img/活动详情.png" alt="">
				<div class="activity-content">
					<img class="person" src=".//Public/img/人物.png">
					<div class="cqupt-helper">
						<img class="cqupt" src=".//Public/img/cqupt-helper.jpg" alt="">
					</div>

					<div class="about-activity">
						<p><span class="activity-time">活动时间：</span>本次线上参与活动时间为<span class="activity-detime">8月8日8：00——9月6日8：00</span></p>
						...
						<p class="career-talk">红岩网校工作站2016新生交流群:459832901<?php echo ($sex1); ?>..<?php echo ($sex2); ?></p>
					</div>
				</div>
			...
			<div class="smile-face">
				<img src=".//Public/img/笑脸展示.png" alt="">
				<div>
					<div class="select-condition">
						...
						<div class="condition-right">
							...
							<img src=".//Public/img/搜索按钮.png" alt="" class="search-btn">
						</div>
					</div>
		...
		<div class="submit-box">
			<form action="">
				...
				<img src=".//Public/img/name.png" alt="" class="usrname">
				<img src=".//Public/img/dividing.png" alt="" class="name-dividing">
				<input type="password" class="password" placeholder="身份证后六位">
				<img src=".//Public/img/password.png" alt="" class="usrpwd">
		...
		<div class="uploading-box">
			...
			<p>我们不会透露你的联系方式</p>
			<img src=".//Public/img/publish.png" class="hand-in">
		</div>
		<!-- 照片上传成功窗口 -->
		<div class="submit-boxing"></div>
		<div class="uploading-success-box">
			<img src=".//Public/img/push-sucess.png" alt="" class="success-icon">
			<p>关注重邮小帮手（微信号：cyxbswx）并绑定学号，我们将审核结果推送给你</p>
			<img src=".//Public/img/cqupt-helper.jpg" alt="" class="cqupt-helper">
			<img src=".//Public/img/确认.png" alt="" class="confirm">
		</div>
		<!-- 查看详情 -->
		<div class="submit-boxing"></div>
		...
		<div class="please-login">
			...
			<img class="w" src=".//Public/img/w.png">
		</div>
		...
		<div class="fail">
			<img src=".//Public/img/type-err.png">
		...
		<div class="uploading-wait">
			<img class="uploading-w" src=".//Public/img/uploading-w.png">
	...
	console.log("page_test1");
			...
			$.get("./<?php echo U('Home/Index/get_page');?>", "fetchpage=1", function (data) {
				...
				function showData(data){
					...
					for(i = 0;i < data.length;i++){
						...
						oDiv = '<div top=' + obj.id + ' vote=' + obj.vote　+ ' uid=' + obj.uid + ' big-pic=' + obj.big_pic +' class="speciel ' + obj.class_name +'"><span class="ranking">'+"top" + obj.id +'</span><div class="person-img"><img src=".//Public/allimage/'+ obj.pic +'" alt=""></div><img src=".//Public/img/love.png" alt="" class="love-nolove"><span class="love-people">'+ obj.vote +'</span><img class="detail" src=".//Public/img/详情.png" alt=""></div>';
		...
		function login(){
			...
			$(".submit").click(function () {
				...
				if(!exp.test(name)){
					waiting.html('<p class="logining">你不是小鲜肉</p><img class="w" src=".//Public/img/w.png">');
					setTimeout(function () {
				...
				setTimeout(function () {
					$.post("./<?php echo U('Home/Index/log');?>","username=" + name + "&&password=" + pass,function (res) {
						...
						if(res.status == 200){
							...
							waiting.html('<p class="logining">账号密码错误</p><img class="w" src=".//Public/img/w.png">');
							setTimeout(function () {
								window.location = window.location.href;
							},2000);
						}
		...
		function addIn(){
			...
			$(".add-in-file").change(function (e) {
				...
				$(".hand-in").attr('src',".//Public/img/readyPublish.png");
